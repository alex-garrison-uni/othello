...
- `diagrams/images/` contains the images of each of these diagrams.
...
| `get_ai_move`<br>**Main AI function**. | Generates an optimal AI move for a given board and colour. | ![get_ai_move.png](/diagrams/images/get_ai_move.png) |
...
| `get_potential_board_states` | Returns a mapping of potential moves to board states from a given board state, for a given colour. | ![get_potential_board_states.png](/diagrams/images/get_potential_board_states.png) |
| `get_board_position_metrics` | Returns metrics about the count of cells positioned around the board, by colour.<br><br>Counts the number of each cell for:<br>- Corner / Corner adjacent / Corner double adjacent<br>- Edge / Edge adjacent / Edge double adjacent | ![get_board_position_metrics.png](/diagrams/images/get_board_position_metrics.png) |
...
| `legal_move` | Returns if a move is legal for a colour on a given Othello board. | ![legal_move.png](/diagrams/images/legal_move.png) |
| `make_move` | Makes a given move on the board. | ![make_move.png](/diagrams/images/make_move.png) |
...
| `get_legal_moves` | Returns a list of legal moves for a given board and colour. | ![get_legal_moves.png](/diagrams/images/get_legal_moves.png) |
...
| `simple_game_loop`<br>**Main game engine function**. | The main CLI game loop.<br><br>After one completed game it will exit. | ![simple_game_loop.png](/diagrams/images/simple_game_loop.png) |
